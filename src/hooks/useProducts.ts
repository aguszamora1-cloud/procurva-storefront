...
`;
const PRODUCT_COLUMNS = `${COLS_BASE}, is_featured, is_new_arrival, display_variants_separately`;
...
export function useProducts(): ProductsState {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (error && /is_featured|is_new_arrival|display_variants_separately/i.test(error.message)) {
