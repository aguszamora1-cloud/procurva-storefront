          ...
          <div className="space-y-3 pt-1">
            ...
            {inquiry && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex w-full items-center justify-center gap-2 rounded-[8px] border-[1.5px] border-[#25D366] bg-[#25D366] px-6 py-[14px] text-[14px] font-semibold text-white transition-colors hover:border-[#1DA851] hover:bg-[#1DA851] active:border-[#128C4E] active:bg-[#128C4E]"
              >
